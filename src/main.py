...
#             self.redirect("/targets")
    ...
    def post(self):
        ...
        if subject and content:
            ...
            self.render("profile.html", subject=subject, content=content, error=error)
...
class MemcacheFlush(BlogHandler):
    def get(self):
        memcache.flush_all()
        self.redirect('/')
